...
<!doctype html>
	...
	<head>
		...
		<link rel="shortcut icon" href="<?php echo $root; ?>assets/images/header/logo.png" type="image/x-icon">

		<link href="https://fonts.googleapis.com/css?family=Roboto:400,700,900&display=swap" rel="stylesheet">

		<link rel="stylesheet" href="<?php echo $root; ?>assets/form/fonts/icomoon/style.css">


		<!-- Bootstrap CSS -->
		<link rel="stylesheet" href="<?php echo $root; ?>assets/form/css/bootstrap.min.css">

		<!-- Style -->
		<link rel="stylesheet" href="<?php echo $root; ?>assets/form/css/style.css">
		<link rel="stylesheet" type="text/css" href="<?php echo $root; ?>assets/css/ypkp.css">
	...
	<body>
		<?php 
			$get_jurusan = http_request($api_link.'api/get-jurusan');
			...
			*/
			...
			$cek_gelombang = http_request($api_link.'api/cek-gelombang');
			$result_cek_gelombang = json_decode($cek_gelombang, true);
			$count_gelombang = count($result_cek_gelombang['data']);

			foreach($result_cek_gelombang['data'] as $valueGelombang){
			...
			<div class="row align-items-stretch justify-content-center no-gutters">
				<div class="col-md-7">
					<div class="form h-100 contact-wrap p-5" style="background: #282828;">
						<img class="img-logo" src="<?php echo $root; ?>assets/images/header/logo.png">
					...
					?>
						...
						<form action="<?php echo $api_link; ?>api/pmb-post" method="POST" enctype="multipart/form-data" class="mb-5" id="formDaftar" name="formDaftar">
							<div class="row">
							...
							<div class="row">
								<div class="col-md-12 form-group mb-3">
									<label for="budget" class="col-form-label">
										...
										<span class="note-file-form">(Silahkan unduh formulir dengan klik tombol unduh setelah diisi kemudian upload)</span>&nbsp;&nbsp; <a class="" href="<?php echo $root ?>assets/dok/format pendaftaran pascasarjana.docx" download>Unduh</a><br>
							...
							<div class="row">
								<div class="col-md-6 form-group mb-3">
									<label for="budget" class="col-form-label">
										Scan Sertifikat TOEFL minimal 500*Jika ada<span class="star-form"></span><br> 
										<span id="note_toefl" class="note-file-form">(format PDF maksimal 500 kb)</span> 
									</label>
									<input type="file" class="form-control form-pmb" name="toefl" id="toefl" accept=".pdf" onchange="file_validasi('pdf', 'toefl', 'note_toefl');">
								</div>
								<div class="col-md-6 form-group mb-3">
									<label for="budget" class="col-form-label">
							...
							<div class="row">
								...
								<div class="col-md-6 form-group mb-3">
									...
									<p style="font-size:12px;line-height: 15px;"><br>
										<b>Silahkan transfer pembayaran ke rekening di bawah :</b><br><br>
										<?php
											echo 'Bank : '.$result_get_setting['data']['nama_bank'].'<br>';
											echo 'Atas nama : '.$result_get_setting['data']['nama_rekening'].'<br>';
											echo 'Nomor rekening : '.$result_get_setting['data']['nomor_rekening'];
										?>
	...
	<div id="loading_id" class="loading loadingh">
			<div class="container col-lg-8 col-sm-10 col-md-12" style="background:#000; height:620px;">
				...
				<img width="200" src="<?php echo $root; ?>assets/images/gif/loading.gif">
			</div>
	</div>
	<!--
	<div class="floatwa">
		<a href="https://api.whatsapp.com/send?phone=6282128211958&text=Halo%20Tim%20Pendaftaran%20Online%20Pascasarjana%20Universitas%20Sangga%20Buana%20!" target="_blank" target="_blank"><img style="width:80%" src="<?php echo $root; ?>assets/images/whatsapp.png"></a>
	</div>
	-->
	<script src="<?php echo $root; ?>assets/form/js/jquery-3.3.1.min.js"></script>
	<script src="<?php echo $root; ?>assets/form/js/popper.min.js"></script>
	<script src="<?php echo $root; ?>assets/form/js/bootstrap.min.js"></script>
	<script src="<?php echo $root; ?>assets/form/js/jquery.validate.min.js"></script>
	<script src="<?php echo $root; ?>assets/form/js/main.js?v=<?php echo date('His'); ?>"></script>
	...
	<script type="text/javascript">
		...
		{ 
			...
			$.ajax({
				type: 'POST',
				//url: 'https://super.pascasarjanausbypkp.ac.id/api/get-konsentrasi',
				url: 'http://localhost/ypkpback/api/get-konsentrasi',
				dataType: 'json',
				data: {id_jurusan: id_jurusan},
				success: function(response){
					$("#konsentrasi").html("<option class='option-form' value=''>Pilih Konsentrasi</option>");  
					
					var konsentrasi;
					$.each(response.data, function(i,n){
						konsentrasi = konsentrasi + "<option class='option-form' value=" + n["konsentrasi"] + ">"+n["konsentrasi"]+"</option>";
					});
					$('#konsentrasi').append(konsentrasi);
				}
        	});
