...
<html>
	<head>
		...
		<style>
			.headline07{background:#FFF;padding:7px 2px 5px 2px; text-align:center;border-radius:10px;color:#DE2525;}
			@media (min-width:552px){.headline07{font-size:20px;}}
			@media /*(min-width:416px) and */(max-width:551px){.headline07{font-size:15px;}}
			/*@media (max-width:415px){.headline07{font-size:13px;}}*/
			@media (min-width:768px) and (max-width:991px){.nav-07{padding-left:100px !important;margin-top:-27px;}}
		</style>
	</head>
			...
			<nav class="navbar-wrapper navbar-default" role="navigation">
				<div class="container">
					...
					<div id="navbar-scroll" class="collapse navbar-collapse navbar-themers navbar-right">
						<ul class="nav navbar-nav nav-07">
		...
		<div class="fullscreen landing banner bg-carousel" style="/*background-image:url('images/bg.jpg');">
			<div class="overlay">
				<div class="container" style="width: 100%;">
					...
					<div class="col-md-6">
						<br><div class="headline07 landing-text wow fadeInRight">Raih Gelar Magister-mu Tanpa Harus ke Kampus</div>
					</div>
					...
					<div class="col-md-6 padding-carousel">
						<!-- /.main title -->
							...
							<img style="margin-top: -60px;" src="assets/images/carousel/img_2.png" alt="phone" class="header-phone img-responsive wow fadeInLeft carousel-pc">
							<img style="margin-top: -70px; width: 100%;" src="assets/images/carousel/teteh-mobile.png" alt="phone" class="header-phone img-responsive wow fadeInLeft carousel-mobile">
							<br>
							<!-- /.header paragraph -->
					...
					<div class="col-md-6 carousel-pc">
						<!--
						<div class="landing-text wow fadeInRight" style="margin-top:35px; text-align:left;font-size:19px;">
							<p>Raih Gelar Magister-mu Tanpa Harus ke Kampus</p>
						</div>-->
						<img style="margin-top: -60px; width:100%;" src="assets/images/carousel/siteteh.png" alt="phone" class="header-phone img-responsive wow fadeInRight">
			...
			<div class="container" style="width:100%;">
				<div class="row">
					<div class="col-md-12 col-sm-12 wow fadeInRight animated bg-perkuliahan" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; -webkit-animation-delay: 0.8s; animation-name: fadeInRight; -webkit-animation-name: fadeInRight;">
						...
						<h1 class="title title-page title-perkuliahan-pl" style="max-width:950px;">Virtual Synchronous, Selft Paced & Collaborative Asynchronous Learning</h1>
						...
						<div class="feature-item">
							<div class="media">
								...
								<div class="media-body perkuliahan-ml">
									...
									<p style="font-size: 20px; max-width: 500px;text-align:justify;">Menerapkan sistem pembelajaran secara Online (Virtual Synchronous, Selft Paced & Collaborative Asynchronous), dengan materi yang lebih luas, lebih banyak, bervariasi, dan mudah diakses yang telah terintegrasi.</p>
			...
			<div class="container">
				...
				<div class="row row-feat">
					...
					<div class="col-md-12">
						...
						<div class="col-md-6">
							<img style="width:100%;" src="assets/images/keunggulan/8.png">
						</div>
			...
			<div class="container">
				...
				<div class="row screenshots" style="margin-top: -50px;">
					<div id="screenshots" class="owl-carousel">
						<!-- /.screenshot images -->
						<?php
							$get_galeri =  http_request($api_link."api/get-galeri");
							$result_get_galeri = json_decode($get_galeri, true);
							foreach ($result_get_galeri['data'] as $key => $valueGaleri) {
						?>
						<div class="screen wow fadeInUp" style="height:200px;">
							<a href="assets/images/galeri/<?php echo $valueGaleri['img']; ?>" data-toggle="lightbox"><img style="max-width:100%;max-height:100%;" src="assets/images/galeri/<?php echo $valueGaleri['img']; ?>" alt="Screenshot"></a>
						</div>
						<?php } ?>
					...
					<div class="row contact-row">
						...
						<div class="col-sm-4 contact-left wow fadeInUp">
							...
							<ul class="ul-address">
								...
								<li style="color: #FFF;">
									Jl. Surapati No. 189, Sukaluyu, Kec. Cibeunying Kaler, Kota Bandung, Jawa Barat 40123
								</li>
							</ul>	
						...
						<div class="col-sm-4 contact-left wow fadeInUp">
							...
							<div class="social text-left">
								<ul  style="padding-left: 30px;">
									...
									<li><a style="background: transparent; border: none;" class="wow fadeInUp" href="tel:+62227275489" data-wow-delay="0.2s"><img width="40" src="assets/images/hubungi/tel.png"></a></li>
								</ul>
							</div>	
						</div>
					</div>
